...
def SplitWd(txt,wd_id):
    ...
    # 统计与环境相关词汇出现的频次
    key_list = ['生态', '环境', '保护', '环境保护', '污染', '资源', '监测', '排放', '提高', '防治', '责任', '污染物', '治理',
                '绿色', '强化', '监管', '规划', '督察', '环境监测', '预警', '保障', '红线', '监督', '农业', '环境保护部',
                '流域', '水资源', '整治', '公园', '优化', '改善', '农村', '排污', '应急', '损害', '土壤环境', '大气',
                '水源', '能源', '环境质量', '改造', '节能', '土地', '耕地', '地下水', '管控', '违法', '维护', '水质', '示范',
                '用水', '煤炭', '海洋', '饮用水', '草原', '淘汰', '燃煤', '回收', '土壤', '责令', '节水', '污染源', '产能',
                '环境治理', '农产品', '水体', '河湖', '垃圾', '检查', '减排', '破坏', '环境污染', '养殖', '海域', '严格控制',
                '覆盖', '森林', '节约', '整改', '防控', '达标', '违反', '污水', '基础设施', '损害赔偿', '监督管理', '环境影响',
                '重金属', '畜禽', '生态环境', '绿色发展', '自然资源', '土地资源', '农业面污染防治',
                '自然资源资产离任审计', '自然资源资产负债表', '中央环境保护督察']
    nums = []
    for kw in key_list:
        try:
            num = dic[kw]
    ...
    with open(r'词汇词频分析.csv','a', encoding='utf-8') as fp:
        fp.write('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,'
                 '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,'
                 '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,'
                 '%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s \n' %
                 (wd_id,
                  nums[0], nums[1], nums[2], nums[3],nums[4], nums[5], nums[6], nums[7],nums[8], nums[9], nums[10],
                  nums[11],nums[12], nums[13], nums[14], nums[15],nums[16], nums[17], nums[18], nums[19],nums[20],
                  nums[21], nums[22], nums[23],nums[24],nums[25], nums[26], nums[27], nums[28],nums[29], nums[30],
                  nums[31], nums[32],nums[33], nums[34], nums[35], nums[36],nums[37], nums[38],nums[39], nums[40],

                  nums[41], nums[42], nums[43], nums[44], nums[45], nums[46], nums[47], nums[48], nums[49], nums[50], nums[51],
                  nums[52], nums[53], nums[54], nums[55], nums[56], nums[57], nums[58], nums[59], nums[60],
                  nums[61], nums[62], nums[63], nums[64], nums[25], nums[26], nums[27], nums[28], nums[29], nums[30],
                  nums[31], nums[32], nums[33], nums[34], nums[35], nums[36], nums[37], nums[38], nums[39], nums[40],
                  nums[0], nums[1], nums[2], nums[3], nums[4], nums[5], nums[6], nums[7], nums[8], nums[9], nums[10],
                  nums[11], nums[12], nums[13], nums[14], nums[15], nums[16], nums[17], nums[18], nums[19], nums[20],
                  nums[21], nums[22], nums[23], nums[24], nums[25], nums[26], nums[27], nums[28], nums[29], nums[30],
